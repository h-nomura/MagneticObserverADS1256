...
typedef struct
{
	...
	uint8_t ScanMode;	/*Scanning mode,   0  Single-ended input  8 channelÅC 1 Differential input  4 channel*/
}ADS1256_VAR_T;



/*Register definitionÅF Table 23. Register Map --- ADS1256 datasheet Page 30*/
enum
{
...
/* Command definitionÅF TTable 24. Command Definitions --- ADS1256 datasheet Page 34 */
enum
{
...
*	function: Configuration of the STM32 GPIO and SPI interfaceÅCThe connection ADS1256
*	parameter: NULL
...
//ADS1256_CfgADC(ADS1256_GAIN_1, ADS1256_1000SPS);	/* îzíuADCéQêîÅF ˙ùâv1:1, êîêò?èoë¨ó¶ 1KHz */
}
...
*	parameter: _ucDiffMode : 0  Single-ended input  8 channelÅC 1 Differential input  4 channe
*	The return value: NULL
*********************************************************************************************************
*/
void ADS1256_StartScan(uint8_t _ucScanMode)
		...
		*/
		...
		/*	ADCON: A/D Control Register (Address 02h)
			...
			Bits 4-3 SDCS1, SCDS0: Sensor Detect Current Sources
				...
				01 = Sensor Detect Current = 0.5 É  A
				10 = Sensor Detect Current = 2 É  A
				11 = Sensor Detect Current = 10É  A
...
static void ADS1256_SetChannal(uint8_t _ch)
{
	...
	Bits 7-4 PSEL3, PSEL2, PSEL1, PSEL0: Positive Input Channel (AINP) Select
		...
		1xxx = AINCOM (when PSEL3 = 1, PSEL2, PSEL1, PSEL0 are ÅgdonÅft careÅh)
	...
	Bits 3-0 NSEL3, NSEL2, NSEL1, NSEL0: Negative Input Channel (AINN)Select
		...
		0110 = AIN6 (ADS1256 only)
		0111 = AIN7 (ADS1256 only)
		1xxx = AINCOM (when NSEL3 = 1, NSEL2, NSEL1, NSEL0 are ÅgdonÅft careÅh)
	*/
	if (_ch > 7)
	{
		return;
...
static void ADS1256_SetDiffChannal(uint8_t _ch)
{
	...
	*/
	if (_ch == 0)
	{
		ADS1256_WriteReg(REG_MUX, (0 << 4) | 1);	/* DiffChannal  AIN0ÅC AIN1 */
	}
	else if (_ch == 1)
	{
		ADS1256_WriteReg(REG_MUX, (2 << 4) | 3);	/*DiffChannal   AIN2ÅC AIN3 */
	}
	else if (_ch == 2)
	{
		ADS1256_WriteReg(REG_MUX, (4 << 4) | 5);	/*DiffChannal    AIN4ÅC AIN5 */
	}
	else if (_ch == 3)
	{
		ADS1256_WriteReg(REG_MUX, (6 << 4) | 7);	/*DiffChannal   AIN6ÅC AIN7 */
	}
}
...
void ADS1256_ISR(void)
{
	if (g_tADS1256.ScanMode == 0)	/*  0  Single-ended input  8 channelÅC 1 Differential input  4 channe */
	{
