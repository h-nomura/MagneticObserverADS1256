...
def Process(fileName,StartTime,EndTime, F_flag ,Yrange):
    ...
    if siteInfo == "@inabu_Flux":
        Pass += "1sec_FGM@inabu/" + fileName
    elif siteInfo == "@inabu_byNo1":
        Pass += "1sec_MIM-Pi1@inabu/" + fileName
    elif siteInfo == "@inabu_byNo2":
        Pass += "1sec_MIM-Pi2@inabu/" + fileName
    ...
    for i in range(24):
        ...
        if i != 23:
            ...
            try:
                ...
                print("ERRER" + File +" Time == "+ ProcessTime)
        else:
