...
def Timecode_matching(df):
    ...
    result.append(pd.DataFrame({'time':rawtime,'1ch':raw1ch_0,'2ch':raw2ch_0,'3ch':raw3ch_0,'4ch':raw4ch_0}))
    result.append(pd.DataFrame({'time':rawtime,'1ch':raw1ch_1,'2ch':raw2ch_1,'3ch':raw3ch_1,'4ch':raw4ch_1}))
    return result
...
def main():
    File = [
    "MI20-11-19_00h00m00s@inabu_byNo1.csv",
    "MI20-11-19_00h00m00s@inabu_byNo2.csv",
    "Fx20-11-19_00h00m00s@inabu_Flux.csv"]
